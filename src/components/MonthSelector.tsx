...
const MonthSelector = () => {
  ...
  const months = [
    { date: prev, label: format(prev, "MMM"), subLabel: format(prev, "yyyy") },
    { date: selectedMonth, label: format(selectedMonth, "MMM"), subLabel: format(selectedMonth, "yyyy") },
    { date: next, label: format(next, "MMM"), subLabel: format(next, "yyyy") },
  ];
