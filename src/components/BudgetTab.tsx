          ...
          <div className="rounded-xl bg-card p-3 border border-border text-center">
            ...
            <div className="flex justify-center gap-3 mt-0.5">
              ...
              <p className={`text-[10px] font-semibold tabular-nums ${(totalBudgetedIncome - totalIncome) >= 0 ? "text-green-500" : "text-expense"}`}>
                {(totalBudgetedIncome - totalIncome) < 0 ? "-" : ""}${Math.abs(totalBudgetedIncome - totalIncome).toLocaleString("en-US", { minimumFractionDigits: 2 })} rem
              </p>
            </div>
          </div>
          <div className="rounded-xl bg-card p-3 border border-border text-center">
            ...
            <div className="flex justify-center gap-3 mt-0.5">
              ...
              <p className={`text-[10px] font-semibold tabular-nums ${(totalBudgetedExpenses - totalExpenses) >= 0 ? "text-green-500" : "text-expense"}`}>
                {(totalBudgetedExpenses - totalExpenses) < 0 ? "-" : ""}${Math.abs(totalBudgetedExpenses - totalExpenses).toLocaleString("en-US", { minimumFractionDigits: 2 })} rem
              </p>
            </div>
          </div>
        </div>
